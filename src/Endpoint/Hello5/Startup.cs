...
using Hello5.Domain.DataAccess.Database;
using Hello5.Domain.DataAccess.Database.Echo.Interfaces;
using Hello5.Domain.SDK.Caching.Extensions;
...
namespace Hello5.Domain.Endpoint
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            {
                c.SwaggerDoc("v2", new OpenApiInfo { Title = "Hello5 V2", Version = "2.0" });
                c.SwaggerDoc("v1", new OpenApiInfo { Title = "Hello5 V1", Version = "1.0" });
            });
        }
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env, ILoggerFactory loggerFactory)
        {
                ...
                env.IsEnvironment(EnvConst.Debug))
            {
                ...
                app.UseSwagger();
                app.UseSwaggerUI(c => c.SwaggerEndpoint("/swagger/v2/swagger.json", "Hello5 v2"));
                app.UseSwaggerUI(c => c.SwaggerEndpoint("/swagger/v1/swagger.json", "Hello5 v1"));
            }
